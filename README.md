...
- 上部のメニューバーで
  ...
  ![5_1](./image/5_1.png)<br><br>
  ![5_2](./image/5_2.png)<br><br>
  - <プロジェクト名>.qsf に以下の文が含まれていることを確認
  ```
...
- 上部のメニューバーで
  - Project -> Revisions
  ![5_3](./image/5_3.png)<br><br>
  - << new revision >> をダブルクリック
  ![5_4](./image/5_4.png)<br><br>
  - revision名を入力
